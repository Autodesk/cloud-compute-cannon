...
class Constants
{
	...
	inline public static var SERVER_MOUNTED_CONFIG_FILE = '/config/serverconfig.yml';
	inline public static var BOOT2DOCKER_PROVIDER_STORAGE_PATH = 'serverconfig.yml';
