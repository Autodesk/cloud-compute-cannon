...
abstract ComputeClientP(ComputeClient) from ComputeClient
{
	...
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.getServers.bind(this), RETRIES, RETRIES_INTERVAL, 'ComputeClient.getServers');
	}

	inline public function createServer(options :ComputeServerCreateOptions) :Promise<PkgCloudServer>
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.createServer.bind(this, options), RETRIES, RETRIES_INTERVAL, 'ComputeClient.createServer');
	}

	inline public function destroyServer(serverId :String) :Promise<PkgCloudServer>
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.destroyServer.bind(this, serverId), RETRIES, RETRIES_INTERVAL, 'ComputeClient.destroyServer');
	}

	inline public function getServer(serverId :String) :Promise<PkgCloudServer>
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.getServer.bind(this, serverId), RETRIES, RETRIES_INTERVAL, 'ComputeClient.getServer');
	}

	inline public function rebootServer(serverId :String) :Promise<PkgCloudServer>
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.rebootServer.bind(this, serverId), RETRIES, RETRIES_INTERVAL, 'ComputeClient.rebootServer');
	}


	inline public function getImages() :Promise<Array<Image>>
	{
		return RetryPromise.retryDecayingInterval(ClientImplCompute.getImages.bind(this), RETRIES, RETRIES_INTERVAL, 'ComputeClient.getImages');
	}
}
